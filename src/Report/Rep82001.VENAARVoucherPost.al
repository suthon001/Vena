/// <summary>
/// Report VENA AR Voucher (Post) (ID 82001).
/// </summary>
report 82001 "VENA AR Voucher (Post)"
{
    Permissions = TableData "G/L Entry" = rimd;
    Caption = 'AR Voucher';
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/Report_82001_ARVoucherPosted.rdl';
    ...
    dataset
    {
        dataitem(GLEntry; "G/L Entry")
        {
            ...
            UseTemporary = true;
            column(PaymentTerm; SalesHeader."Payment Terms Code") { }
