/// <summary>
/// Report VENA Sales Receipt (ID 82004).
/// </summary>
report 82004 "VENA Sales Receipt"
{
    Caption = 'Sales Receipt';
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/Report_82004_SalesReceipt.rdl';
    ...
    dataset
    {
        dataitem(BillingReceiptHeader; "YVS Billing Receipt Header")
        {
            ...
            column(Amount_BeforVat; "VENA Total Sales (LCY)") { }
            column(VatAmt; "Amount" - "VENA Total Sales (LCY)") { }
