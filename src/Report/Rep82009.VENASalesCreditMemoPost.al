/// <summary>
/// Report VENA Sales Credit Memo (Post) (ID 82009).
/// </summary>
report 82009 "VENA Sales Credit Memo (Post)"
{
    Caption = 'Sales Credit Memo';
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/Report_82009_SalesCreditMemoPosted.rdl';
    ...
    dataset
    {
        dataitem(SalesHeader; "Sales Cr.Memo Header")
        {
            ...
            begin
                ...
                if NOT Reason.Get("Reason Code") then
                    Reason.init();
                ReturnReasonDescFirstLine := Reason.Description;
            end;
        }
    }
    requestpage
