/// <summary>
/// Report VENA Sales Invoice (Post) (ID 82003).
/// </summary>
report 82003 "VENA Sales Invoice (Post)"
{
    Caption = 'Sales Invoice';
    DefaultLayout = RDLC;
    RDLCLayout = './LayoutReport/Report_82003_SalesInvoicePosted.rdl';
    ...
    dataset
    {
        dataitem(SalesHeader; "Sales Invoice Header")
        {
            ...
            column(PaymentMethod_Desc; PaymentMethod.Description) { }
